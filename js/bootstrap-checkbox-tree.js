!function ($) {
  ...
  CheckboxTree.prototype.initMarkup = function() {
    // Add tree collapse/expand links
    this.$element.find("li").prepend('<span>&nbsp;</span>');
  };

  CheckboxTree.prototype.checkboxTicked = function(e) {
  ...
  CheckboxTree.prototype.expandOrCollapseBranch = function(e) {
  ...
  CheckboxTree.prototype.expandAll = function() {
    // Show all children
  ...
  CheckboxTree.prototype.collapseAll = function() {
    // Hide all children
  ...
  CheckboxTree.prototype.defaultExpand = function() {
  ...
  CheckboxTree.prototype.expandEl = function($el) {
    $el.removeClass("collapsed").addClass("expanded").html(this.options.closeHtml);
  };

  CheckboxTree.prototype.collapseEl = function($el) {
